#!/usr/bin/python3
"""
Este script muestra las interfaces de red disponibles en el sistema,
...
def get_network_interfaces():
    """
    Obtiene y muestra información básica sobre las interfaces de red:
...
def get_hostname_info():
    """
    Muestra información del hostname y dirección IP principal.
    """
    print("\n" + "=" * 60)
...
def main():
    """
    Función principal que ejecuta las funciones de información de red.
    """
    print("\nOBTENIENDO INFORMACIÓN DE INTERFACES DE RED...\n")
